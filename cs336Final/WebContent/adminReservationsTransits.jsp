...
<head>
	...
	<title>Admin | Transit Reservations</title>
	<style>
	*,html {
		margin: 0;
		padding: 0;
...
<body>
	<div class="container">
		...
		<%
		if(tnum.isEmpty() || tnum == null) {
			out.print("<div class='header'><b>"+tline+"</b></div>");
		}else{
			out.print("<div class='header'><b>"+tline+" #"+tnum+"</b></div>");
		}
		%>
		<br><br>
		...
		<%
			...
			<table align="center" cellpadding="0" cellspacing="0" border="1">
				...
				<td class="topCell"><b>Customer Rep SSN</b></td>
				...
				try{
					...
					if(tnum != null || !tnum.isEmpty()) {
						reservations = "SELECT * FROM Reservations r, Seats s WHERE r.route_name='"+tline+"' and tid='"+tnum+"' and r.tid = s.trains_tid and r.seat_no = s.seat_number";
					} else {
						reservations = "SELECT * FROM Reservations WHERE route_name='"+tline+"'";
					}
