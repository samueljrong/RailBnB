...
<body>
	...
	<form method="post" action="searchSchedules.jsp">
		<input class="btn" type="submit" value="Search for Routes">
	</form>
	<br>

	<form method="post" action="viewQandA.jsp">
		<input class="btn" type="submit" value="Q&A Forum">
	</form>
	<br>

	<form method="post" action="myAlerts.jsp">
		<input class="btn" type="submit" value="Alerts">
	</form>
	<br>
