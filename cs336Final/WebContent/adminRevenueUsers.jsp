...
<body>
	<div class="container">
		...
		<h4>By Customer</h4><br>
			<table align="center" cellpadding="0" cellspacing="0" border="1">
				<tr>
				<td class="topCell"><b>Customer Username</b></td>
				...
				try{ 
					String revenues = "SELECT userid, SUM(booking_fee) as revenue FROM Reservations GROUP BY userid";
