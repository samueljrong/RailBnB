...
<title>My Unanswered Questions</title>
</head>
<body>
	...
	<br> <br>
	<b>Filter by:</b>
	<a href="myQuestions.jsp">All My Questions</a>
	<br>
	...
	<%
		...
		String str = "SELECT * FROM Questions WHERE cid='" + session.getAttribute("user") + "' and answer IS NULL";
